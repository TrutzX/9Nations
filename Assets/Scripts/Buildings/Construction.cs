...
namespace Buildings
{
    public class Construction : MonoBehaviour
    {
        ...
        {
            data.construction = new Dictionary<string, int>(construction);
        ...
        public bool RoundConstruct()
        {
            ...
            //buildtime
            if (_data.construction["buildtime"] > 0)
            {
                _data.construction["buildtime"] -= 1;
                //set opacity
            ...
            //finish?
            if (_data.construction.Count == 1 && _data.construction["buildtime"] == 0)
            {
        ...
        public float GetConstructionProcent()
        {
            ...
            return (1f * _data.buildTime - _data.construction["buildtime"]) / _data.buildTime;
        }
